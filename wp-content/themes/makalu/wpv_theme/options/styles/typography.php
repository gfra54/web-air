...
array(
	'name' => __('General Typography', 'wpv'),
	'type' => 'start',
),
...
array(
	'name' => __('Additional Font Styles', 'wpv'),
	'type' => 'separator',
),

array(
	'name' => __('Emphasis Font', 'wpv'),
	'id' => 'em',
	'type' => 'font',
	'min' => 1,
	'max' => 20,
...
array(
	'name' => __('Google Fonts Subsets', 'wpv'),
