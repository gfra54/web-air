...
/********************************************************/
	...
	$GLOBALS['lsPluginPath'] = WPV_PLUGINS_URI . 'layerslider/';
...
/********************************************************/
	...
	function layerslider_enqueue_content_res() {
		...
		wp_enqueue_script('layerslider_js', $GLOBALS['lsPluginPath'].'js/layerslider.kreaturamedia.jquery.js', array('jquery'), $GLOBALS['lsPluginVersion'], true );
		...
		wp_enqueue_script('layerslider_transitions', $GLOBALS['lsPluginPath'].'js/layerslider.transitions.js', array(), $GLOBALS['lsPluginVersion'], true );
		...
		if(file_exists($custom_trs)) {
			wp_enqueue_script('layerslider_custom_transitions', $custom_trs_url, array(), $GLOBALS['lsPluginVersion'], true );
		}
