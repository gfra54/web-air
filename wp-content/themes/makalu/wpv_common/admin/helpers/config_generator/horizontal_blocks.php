					...
					<div class="block">
						<div class="options">
							...
							<div>
								...
								<label>
									<input type="checkbox" name="<?php echo "$id_prefix-$i-empty"?>" id="<?php echo "$id_prefix-$i-empty"?>" value="true" class="<?php wpv_static($value)?>" <?php checked($is_empty, true) ?> />&nbsp;<?php _e('empty?', 'wpv') ?>
								</label>
							</div>
						</div>
					</div>
